...
<div class="sidenav-header">
  ...
  <a class="navbar-brand m-0">
    <img src="../img/core-img/logo2.png" class="navbar-brand-img h-200" alt="main_logo">
...
<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
  <ul class="navbar-nav">
    <li  style="background-color:white;" class="nav-item">
...
<li style="background-color:white;" class="nav-item">
  <a class="nav-link" href="view_products.php">
    ...
    <li style="background-color:white;" class="nav-item">
      <a class="nav-link  " href="view_custom_request.php">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <span class="nav-link-text ms-1">View Custom Request</span>
      </a>
    </li>
    <li  style="background-color:white;"class="nav-item">
      <a class="nav-link  " href="voucher.php">
        ...
        <span class="nav-link-text ms-1">Gift Vouchers</span>
      </a>
    </li>
    <li style="background-color:white;" class="nav-item">
