...
<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg " >
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h2 class="font-weight-bolder text-info text-gradient">Add Product details </h2>
              <br><br>
  <form class="form-detail" action="controller/add_products.php" method="post" enctype="multipart/form-data">
  <div class="row">
      <div class="col-lg-6">
  <div> <h6>Product category:</h6>
  ...
  while ($row2 = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ?>
    <option value="<?php echo $row2['ct_id'] ?>"><?php echo $row2['ct_name'] ?></option>
  <?php } ?>
</select>
    ...
    <input type="text" id="product_name" name="p_name" required><br><br>
   
    <label for="description"><h6>Description:<h6></label>
    <textarea id="description" name="p_description" required></textarea><br><br>
    </div>
    <div class="col-lg-6">
    <label for="price"><h6>Price:<h6></label>
    <input type="number" id="price" name="p_price" required><br><br>
    <div class="table-responsive">
                      <table class="table " id="dynamic_field">

                        <label for="">Add Details</label>
                        <td class="col-sm-5"> <input type="text" name="var[]" placeholder="Add Details" class="form-control name_list" required></td>
    ...
    <input type="file" id="image" name="p_image" accept="image/*" required><br><br>
  </div>
  </div>
    <button name="submit" class="btn bg-gradient-info w-70 mt-4 mb-0">Add Product</button><br><br>
  </form>           
</div>
</main>
