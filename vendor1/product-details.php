            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- btn -->
                        <a href="customize.php" class="backToHome d-block"><i class="fa fa-angle-double-left"></i> Back to customize</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Add to Cart Form -->
<form class="cart clearfix mb-190" action="controller/customize_order.php?p_id=<?php echo $pid; ?>&ct_id=<?php echo $ct_id; ?>" enctype="multipart/form-data" method="post">
    <div class="quantity">
        <input type="hidden" id="selectedSize" name="size" value="">
        <input type="hidden" id="" name="price" value="<?php echo $row['p_price']?>">
        Discription <input name="discript" class="form-control">
        <b> Add Design</b><input class="form-control" type="file" name="customize">
    </div>
    <br><br><br><br><br><br>
    <button style="margin-top:120px; margin-right:1020px;" type="submit" name="addtocart" value="5" class="btn cart-submit d-block">Customize</button>
</form>
