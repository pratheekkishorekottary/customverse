...
<body>
              ...
              <div class="custom-control custom-radio">
                ...
                <div style="display: none;" id="upi_div">
                  ...
                  <div class="billing-address-form">
                    <p><input type="text" id="trid" placeholder="Enter Transaction id" name="trans_id" required></p>
                  </div>
                </div>
              </div>
              <div class="custom-control custom-radio">
                  ...
                  <div class="container d-flex  main">
                    <div class="card">
                      ...
                      <div class="px-3 pt-3">
                        ...
                        <input type="text" class="form-control inputtxt" id="cc-name" name="card_name" placeholder="CARD NAME" required >
                      ...
                      <div class="px-3 pt-3">
                        ...
                        <input type="text" class="form-control inputtxt" id="card_no" name="card_no" placeholder="0000 0000 0000 0000" minlength="16" maxlength="16" required >
                        <div class="invalid-feedback">
                      ...
                      <div class="d-flex justify-content-between px-3 pt-4">
                        <div><label for="date" class="exptxt"> Expiry </label><input type="text" class="form-control expiry" placeholder="MM / YY" id="card_expiry" name="card_expiry" minlength="5" maxlength="5" required>
                          <div class="invalid-feedback">
                            Expiration date required
                          </div>
                        </div>
                        <div><label for="cvv" class="cvvtxt">CVV / CVC</label><input type="text" name="cvv" class="form-control cvv" id="exp" minlength="3" maxlength="3" required >
                          <div class="invalid-feedback">
    ...
    function cardform(myvalue) {
      ...
      if (myvalue == 'card') { //radio button id
        ...
        document.getElementById('card_no').setAttribute('required');
        ...
        document.getElementById('card_no').removeAttribute('required');
